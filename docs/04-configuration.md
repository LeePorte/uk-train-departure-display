...
| `enablePlatformLoop` | `True` (if you you wish to display more platforms than you have screens)
| `platformLoopList` | `1,2,3,4,5` (the list of platforms that you wish to display)
| `platformLoopDisplayTime` | `45` (the length of time in seconds to display each platform)
